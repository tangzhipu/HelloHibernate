package ouc.jeep.optimize.sessionfactory.cache;
...
public class TwoCacheTest {
	...
	static{
		...
		//加载配置文件
		configuration.configure("ouc/jeep/optimize/sessionfactory/cache/hibernate.cfg.xml");
	...
	public void testSave(){
		...
		classes.setCname("0005班");
		classes.setDescription("0005");
	...
	public void testBatchSave()throws Exception{
		...
		for(int i=1;i<10;i++){
			Classes classes = new Classes();
			classes.setCname("0001班"+i);
			classes.setDescription("0001"+i);
			session.save(classes);
		}
		transaction.commit();
		Thread.sleep(1000);
